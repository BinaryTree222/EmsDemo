    ...
    <div class="table wrapper">
        ...
        <div class="th">
            <div class="pro clearfix"><label class="fl">
                <input type="checkbox" name="ck" value="${c.cartId}"/><span></span></label>
                <a class="fl" href="${pageContext.request.contextPath}/todetail.pro?id=${c.cartPid}">
                <dl class="clearfix">
                    <dt class="fl"><img style="width: 100px;height: 100px;" src="img/product/${c.cartPFilename}"></dt>
                    <dd class="fl"><p>${c.cartPName}</p>
                        <p>颜色分类:</p>
                        <p>白色瓷瓶+白色串枚</p></dd>
                </dl>
              </a>
            </div>
            <div class="price">￥${c.cartPPrice}</div>
            <div class="number">
                <p class="num clearfix">
                <img class="fl sub" src="img/temp/sub.jpg">
                <span datasrc="${c.cartId}" class="fl">${c.cartPQuantity}</span>
                <img class="fl add" src="img/temp/add.jpg">
                </p>
            </div>
            <div class="price sAll">￥${c.cartPPrice}</div>
            <div class="price"><a class="del" datasrc="${c.cartId}" href="#2">删除</a></div>
        </div>
        </c:forEach>
...
<script>
    function toorder(){
        ...
        location.href="/EmsDemo_war_exploded/toorder.cart?ids="+str;
    }
</script>
<div class="mask"></div>
