    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/update.pro" method="post" id="myform" name="myform" enctype="multipart/form-data" onsubmit="return checkall()">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="common-text required" id="pName" name="pName" size="50" value="${product.pName}" type="text">
                            </td>
                        </tr>
                        <tr>
                                <th><i class="require-red">*</i>产品描述：</th>
                                <td>
                                    <input class="common-text required" id="pDes" name="pDes" size="50" value="${product.pDes}" type="text">
                                </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>产品价格：</th>
                            <td>
                                <input class="common-text required" id="price" name="price" size="50" value="${product.pPrice}" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>产品数量：</th>
                            <td>
                                <input class="common-text required" id="count" name="count" size="50" value="${product.pCount}" type="text">
                            </td>
                        </tr>
                        <tr>
