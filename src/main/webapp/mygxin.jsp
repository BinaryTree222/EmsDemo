...
<script>
    function loginout() {
        if (confirm("确定要退出吗？")){
        location.href="${pageContext.request.contextPath}/loginout.user";
        }
    }
</script>
<div class="Bott">
    <div class="wrapper clearfix">
        <div class="zuo fl">
            <h3><a href="#"><img src="img/tx.png"/></a>
                <p class="clearfix"><span class="fl">${user.userName}</span><span onclick="loginout()" class="fr">[退出登录]</span></p></h3>
            <div><h4>我的交易</h4>
                <ul>
