    ...
    <div class="orderCon wrapper clearfix">
        <div class="orderL fl"><!--------h3----------------><h3>收件信息<a href="#" class="fr">新增地址</a></h3>
            ...
            <div class="addres clearfix">
                <div class="addre fl on">
                    <div class="tit clearfix"><p class="fl">${user.userName} <span class="default">[默认地址]</span></p>
                        <p class="fr"><a href="#">删除</a><span>|</span><a href="#" class="edit">编辑</a></p></div>
                    <div class="addCon"><p>${user.userAddress}</p>
                        <p>${user.userMobile}</p></div>
                </div>
        ...
        <div class="orderR fr">
            <div class="msg"><h3>订单内容<a href="cart.jsp" class="fr">返回购物车</a></h3><!--------ul---------------->
                ...
                <ul class="clearfix">
                    <li class="fl"><img style="width: 50px;height: 50px;" src="img/product/${l.cartPFilename}"></li>
                    <li class="fl"><p>${l.cartPName}</p>
                        <p>颜色分类：烟灰色玻璃瓶</p>
                        <p>数量：${l.cartPQuantity}</p></li>
                    <li class="fr">￥${l.cartPPrice}</li>
                </ul>
                </c:forEach>
            </div>
            <!--------tips---------------->
            <div class="tips"><p><span class="fl">商品金额：</span><span class="fr">￥${money}</span></p>
                <p><span class="fl">优惠金额：</span><span class="fr">￥0.00</span></p>
                <p><span class="fl">运费：</span><span class="fr">免运费</span></p></div><!--------tips count---------------->
            <div class="count tips"><p><span class="fl">合计：</span><span class="fr">￥${money}</span></p></div>
