...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a><span>/</span><a
            href="decoration.jsp">布艺软饰</a><span>/</span><a href="bzproList.jsp" class="on">抱枕靠垫</a></div>
</div><!-------------------current---------------------->
<div class="current">
    <div class="wrapper clearfix"><h3 class="fl">抱枕靠垫</h3>
...
<ul class="proList wrapper clearfix">
    <c:forEach var="l" items="${aftercatelist}">
        <li>
            <a href="${pageContext.request.contextPath}/todetail.pro?id=${l.pId}">
                <dl>
                    <dt><img src="img/product/${l.pPfilename}"></dt>
                    <dd>${l.pName}</dd>
                    <dd>￥${l.pPrice}</dd>
                </dl>
            </a>
